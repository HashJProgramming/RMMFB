    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                <h3 class="text-dark mb-0">Customer Management</h3><button class="btn btn-dark btn-sm d-none d-sm-inline-block" data-bs-toggle="modal" data-bss-tooltip="" data-bs-placement="left" type="button" data-bs-target="#create" title="Here you can create new staff."><i class="fas fa-user-check fa-sm text-white-50"></i>&nbsp;Create Staff</button>
            </div>
